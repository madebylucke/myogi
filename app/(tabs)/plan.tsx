...
import {size, fontSize, width, height} from "../../constants/ResponsiveSizes";
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.headerDropdown}>
          ...
          <SvgChevronRight style={{transform: [{"rotate": "90deg"}, {translateX: 3}]}} strokeWidth={3}/>
        </View>
      ...
      <View style={styles.workouts}>
        {workouts.map((workout, i)=> (
          <View key={i} style={[styles.workout, i === 0 && {borderBottomLeftRadius: 4,borderBottomRightRadius: 4}, i === workouts.length - 1 && {borderTopLeftRadius: 4, borderTopRightRadius: 4}]}>
